                ...
                <form onSubmit={handleSubmit} id="form1">
                    ...
                    <div className='row'>
                        <div className='col col-lg-6 col-12'>
                            <div className="form-group">
                            <label className='m-1 mt-3'>State</label>
                    ...
                    <label className='m-1 mt-3'>Address</label>
                                <textarea value={address} rows="1" className="form-control" placeholder="Address" onChange={(e) => setAddress(e.target.value)}></textarea>
